...
### Added
  ...
  - [`cigarmath/bam2fastx`](cigarmath/bam2fastx/README.md) [0.0.3] - Added `primary_only` param to skip secondary and supplementary alignments. Added `unique_only` param to emit only the first occurrence of each `query_name`.
